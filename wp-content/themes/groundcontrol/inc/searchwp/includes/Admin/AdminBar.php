...
class AdminBar {
	...
	public static function render() {
		...
		$wp_admin_bar->add_menu( [
			'id'    => Utils::$slug,
			'title' => \SearchWP\License::inactive_license_notice() ? '<span>Ground Control SearchWP</span> <span class="dashicons dashicons-warning searchwp-admin-bar-icon"></span>' : 'Ground Control SearchWP',
