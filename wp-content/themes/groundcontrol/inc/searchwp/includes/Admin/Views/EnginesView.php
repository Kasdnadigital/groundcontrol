...
class EnginesView {
	...
	public function assets() {
		...
		wp_enqueue_script( $handle,
			get_stylesheet_directory_uri() . "/inc/searchwp/assets/javascript/dist/engines{$debug}.js",
			[ 'jquery' ], SEARCHWP_VERSION, true );

		wp_enqueue_style( $handle,
			get_stylesheet_directory_uri() . "/inc/searchwp/assets/javascript/dist/engines{$debug}.css",
			[], SEARCHWP_VERSION );
