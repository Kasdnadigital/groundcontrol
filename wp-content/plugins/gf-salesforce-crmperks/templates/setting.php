...
<div class="howto">  <?php esc_html_e("Callback URL should be same in plugin settings and salesforce APP", 'gravity-forms-salesforce-crm'); ?></div>
 ...
 <div class="crm_field_cell2">
  ...
  <button name="vx_tab_action" value="refresh_lists_<?php echo $this->id ?>" class="button" style="margin-left: 10px; vertical-align: baseline; width: 110px" autocomplete="off" title="<?php esc_html_e('Refresh Picklists','gravity-forms-salesforce-crm'); ?>">Refresh Now</button>
  </div></div>
  <span class="howto">
