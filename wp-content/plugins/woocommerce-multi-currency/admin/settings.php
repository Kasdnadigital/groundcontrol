                                ...
                                <table class="vi-ui table">
                                                    ...
                                                    <select name="<?php echo self::set_field( 'currency_payment_method_' . $currency, 1 ) ?>"
														...
														if ( $payment_gateways ) {
															...
															foreach ( $payment_gateways as $payment_method ) {
																if ( $payment_method->settings['enabled'] === 'yes' ) {
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="2">
                                            ...
                                            <button class="vi-ui green mini button wmc-status-to-yes" type="button">
                                                Yes
                                            </button>
                                            <button class="vi-ui red mini button wmc-status-to-no" type="button">No
                                            </button>
                                        </th>
                                    </tr>
                                    </tfoot>
