...
class WOOMULTI_CURRENCY_Frontend_Shortcode {
	...
	public function shortcode_plain_vertical( $atts, $content = null ) {
		...
		?>
        <div class="woocommerce-multi-currency wmc-shortcode plain-vertical <?php echo esc_attr( $class ) ?>"
	...
	public function shortcode_layout6( $atts, $content = null ) {
		...
		?>
        <div class="woocommerce-multi-currency wmc-shortcode plain-horizontal layout6 <?php echo esc_attr( $class ) ?>"
             data-layout="layout6">
            <input type="hidden" class="wmc-current-url" value="<?php echo esc_attr( $this->current_url ) ?>">
			<?php
			foreach ( $links as $k => $link ) {
	...
	public function shortcode_layout7( $atts, $content = null ) {
		...
		$class            = $this->get_position_option();
		?>
        <div class="woocommerce-multi-currency wmc-shortcode plain-vertical vertical-currency-symbols <?php echo esc_attr( $class ) ?>"
             data-layout="layout7">
            <input type="hidden" class="wmc-current-url" value="<?php echo esc_attr( $this->current_url ) ?>">
            <div class="wmc-currency-wrapper">
				<span class="wmc-current-currency">
	...
	public function shortcode_layout8( $atts, $content = null ) {
		...
		?>
        <div class="woocommerce-multi-currency wmc-shortcode vertical-currency-symbols-circle <?php echo esc_attr( $class ) ?>"
             data-layout="layout8">
            <input type="hidden" class="wmc-current-url" value="<?php echo esc_attr( $this->current_url ) ?>">
            <div class="wmc-currency-wrapper" onclick="">
	...
	public function shortcode_layout9( $atts, $content = null ) {
		...
		ob_start();
		?>
        <div class="woocommerce-multi-currency wmc-shortcode layout9 <?php echo esc_attr( $class ) ?>"
             data-layout="layout9">
            <input type="hidden" class="wmc-current-url" value="<?php echo esc_attr( $this->current_url ) ?>">
            <div class="wmc-currency-wrapper">
				<?php
            ...
            <div class="wmc-currency-wrapper">
                ...
                <div class="wmc-sub-currency">
					<?php foreach ( $links as $k => $link ) {
						...
						?>
                        <div class="wmc-currency <?php echo esc_attr( $hidden ) ?>"
                             data-currency="<?php echo esc_attr( $k ) ?>">
							<?php
							$html = '';
							if ( $this->settings->enable_switch_currency_by_js() ) {
